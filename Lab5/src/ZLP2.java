public class ZLP2 {
    ...
    public static void main(String[] args) {
        ...
        double[] a1 = {16, 1.0 / 5, 6, 3};
        double[] a2 = {12, 2.0 / 5, 5, 4};
        ...
        while ((c[5][1] < 0) || (c[5][2] < 0)) {
            ...
            System.out.printf("___|__f__|%5.1f|%5.1f|%5.1f|\n\n", c[5][1], c[5][2], c[5][3]);
        }
        System.out.printf("Результаты симплекс метода: f(x) = %.1f, x1 = %.1f, x2 = %.1f.\n", c[5][3], c[4][3], c[2][3]);
        //двойственный метод
        double x1 = c[4][3];
        double x2 = c[2][3];
        double[][] d = {
        ...
        if (g == c[5][3])
            System.out.printf("Теорема I выполнена: f(x) = g(y) = %.1f, y1 = %.1f, y4 = %.1f\n", g, y[0], y[3]);
    }
}
